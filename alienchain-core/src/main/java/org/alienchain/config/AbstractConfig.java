...
import org.alienchain.util.StringUtil;
...
public abstract class AbstractConfig implements Config {
    ...
    private static final String CONFIG_FILE = "alienchain.properties";
    ...
    protected Amount minTransactionFee = MILLI_ALX.of(100);
    protected long maxTransactionTimeDrift = TimeUnit.HOURS.toMillis(2);
    protected Amount minDelegateBurnAmount = ALX.of(1000000);
    ...
    protected List<String> netDnsSeedsMainNet = Collections
            .unmodifiableList(Arrays.asList("119.3.24.111", "59.110.240.15","119.23.108.118","47.52.16.146","123.56.88.217"));
