...
import org.alienchain.explorer.model.tables.records.AccountAssetRecord;
...
public class AccountAsset extends TableImpl<AccountAssetRecord> {
    ...
    private static final long serialVersionUID = -2091938102;
    ...
    public List<UniqueKey<AccountAssetRecord>> getKeys() {
        return Arrays.<UniqueKey<AccountAssetRecord>>asList(Keys.KEY_ACCOUNT_ASSET_PRIMARY, Keys.KEY_ACCOUNT_ASSET_ACCOUNT_ASSET_UNIQUE);
    }
