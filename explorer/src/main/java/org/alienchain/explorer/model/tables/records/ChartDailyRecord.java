...
import org.alienchain.explorer.model.tables.ChartDaily;
...
public class ChartDailyRecord extends UpdatableRecordImpl<ChartDailyRecord> implements Record10<ULong, UShort, UShort, UShort, UInteger, UInteger, UInteger, UInteger, Double, Double> {

    private static final long serialVersionUID = -937615652;
     ...
     */
    public void setAvgTxCount(Double value) {
        set(8, value);
    }
     ...
     */
    @Override
    public Row10<ULong, UShort, UShort, UShort, UInteger, UInteger, UInteger, UInteger, Double, Double> fieldsRow() {
     ...
     */
    @Override
    public Row10<ULong, UShort, UShort, UShort, UInteger, UInteger, UInteger, UInteger, Double, Double> valuesRow() {
     ...
     */
    @Override
    public ChartDailyRecord value9(Double value) {
        setAvgTxCount(value);
        return this;
    }
     ...
     */
    @Override
    public ChartDailyRecord values(ULong value1, UShort value2, UShort value3, UShort value4, UInteger value5, UInteger value6, UInteger value7, UInteger value8, Double value9, Double value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ChartDailyRecord(ULong id, UShort day, UShort month, UShort year, UInteger totalTx, UInteger totalBlock, UInteger avgBlockSize, UInteger avgBlockTime, Double avgTxCount, Double avgTxPerSecond) {
        super(ChartDaily.CHART_DAILY);
