...
public class ContractTriggerSmartcontract implements Serializable {

    private static final long serialVersionUID = 1822612918;
    ...
    public ContractTriggerSmartcontract(ContractTriggerSmartcontract value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ContractTriggerSmartcontract (");
