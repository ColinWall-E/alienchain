...
public class ContractUnfreezeAsset implements Serializable {

    private static final long serialVersionUID = -305726446;
    ...
    public ContractUnfreezeAsset(ContractUnfreezeAsset value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ContractUnfreezeAsset (");
