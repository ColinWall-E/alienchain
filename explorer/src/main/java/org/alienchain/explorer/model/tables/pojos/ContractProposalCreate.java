...
public class ContractProposalCreate implements Serializable {

    private static final long serialVersionUID = -1201044330;
    ...
    public ContractProposalCreate(ContractProposalCreate value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ContractProposalCreate (");
