...
import org.alienchain.explorer.model.tables.AccountVote;
...
public class AccountVoteRecord extends UpdatableRecordImpl<AccountVoteRecord> implements Record6<ULong, String, ULong, ULong, ULong, Timestamp> {

    private static final long serialVersionUID = -177830338;
     ...
     */
    @Override
    public Row6<ULong, String, ULong, ULong, ULong, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row6<ULong, String, ULong, ULong, ULong, Timestamp> valuesRow() {
     ...
     */
    @Override
    public AccountVoteRecord values(ULong value1, String value2, ULong value3, ULong value4, ULong value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountVoteRecord(ULong id, String voteAddress, ULong voteAccountId, ULong voteCount, ULong accountId, Timestamp timestamp) {
        super(AccountVote.ACCOUNT_VOTE);
