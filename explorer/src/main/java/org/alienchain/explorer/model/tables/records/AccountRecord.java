...
import org.alienchain.explorer.model.tables.Account;
...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord> implements Record15<ULong, String, Byte, String, Long, ULong, Timestamp, Timestamp, Long, UByte, UByte, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = -122730501;
    ...
    /**
     * Setter for <code>tmp.account.transfer_from_count</code>.
     */
    public void setTransferFromCount(Integer value) {
        set(11, value);
    }

    /**
     * Getter for <code>tmp.account.transfer_from_count</code>.
     */
    ...
    /**
     * Setter for <code>tmp.account.transfer_to_count</code>.
     */
    public void setTransferToCount(Integer value) {
        set(12, value);
    }

    /**
     * Getter for <code>tmp.account.transfer_to_count</code>.
     */
    ...
    /**
     * Setter for <code>tmp.account.tokens_count</code>.
     */
    public void setTokensCount(Integer value) {
        set(13, value);
    }

    /**
     * Getter for <code>tmp.account.tokens_count</code>.
     */
    ...
    /**
     * Setter for <code>tmp.account.participations_count</code>.
     */
    public void setParticipationsCount(Integer value) {
        set(14, value);
    }

    /**
     * Getter for <code>tmp.account.participations_count</code>.
     */
     ...
     */
    @Override
    public Row15<ULong, String, Byte, String, Long, ULong, Timestamp, Timestamp, Long, UByte, UByte, Integer, Integer, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row15<ULong, String, Byte, String, Long, ULong, Timestamp, Timestamp, Long, UByte, UByte, Integer, Integer, Integer, Integer> valuesRow() {
    ...
    public Field<Integer> field12() {
        return Account.ACCOUNT.TRANSFER_FROM_COUNT;
    }
    ...
    public Field<Integer> field13() {
        return Account.ACCOUNT.TRANSFER_TO_COUNT;
    }
    ...
    public Field<Integer> field14() {
        return Account.ACCOUNT.TOKENS_COUNT;
    }
    ...
    public Field<Integer> field15() {
        return Account.ACCOUNT.PARTICIPATIONS_COUNT;
    }
     ...
     */
    @Override
    public AccountRecord value12(Integer value) {
     ...
     */
    @Override
    public AccountRecord value15(Integer value) {
        setParticipationsCount(value);
        return this;
    }
     ...
     */
    @Override
    public AccountRecord values(ULong value1, String value2, Byte value3, String value4, Long value5, ULong value6, Timestamp value7, Timestamp value8, Long value9, UByte value10, UByte value11, Integer value12, Integer value13, Integer value14, Integer value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountRecord(ULong id, String accountName, Byte type, String address, Long balance, ULong allowance, Timestamp latestWithdawTime, Timestamp createTime, Long bandwidth, UByte isWitness, UByte isCommittee, Integer transferFromCount, Integer transferToCount, Integer tokensCount, Integer participationsCount) {
        super(Account.ACCOUNT);
        ...
        set(9, isWitness);
        set(10, isCommittee);
        set(11, transferFromCount);
        set(12, transferToCount);
        set(13, tokensCount);
        set(14, participationsCount);
    }
}
