...
import org.alienchain.explorer.model.tables.records.NodeRecord;
...
public class Node extends TableImpl<NodeRecord> {
    ...
    private static final long serialVersionUID = -691830399;
    ...
    /**
     * The column <code>tmp.node.last_up</code>.
     */
    public final TableField<NodeRecord, Timestamp> LAST_UP = createField("last_up", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
    ...
    public List<UniqueKey<NodeRecord>> getKeys() {
        return Arrays.<UniqueKey<NodeRecord>>asList(Keys.KEY_NODE_PRIMARY, Keys.KEY_NODE_NODE_UNIQUE);
    }
